...
const PARENT_EID  = 'e222747'; // exclude the nacho-week event itself from sub-event list
...
window.FOOD_WEEKS.push(
  ...
  const restaurantsBlock = `window.RESTAURANTS_nacho_2026_cheerio = ${JSON.stringify(entries, null, 2)};\n`;
